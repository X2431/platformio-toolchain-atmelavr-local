...
#define HAVE_recipesf2 ((TARGET_HARD_FLOAT && flag_unsafe_math_optimizations && TARGET_RECIP_DIV) && (TARGET_HARD_FLOAT))
#define HAVE_recipedf2 ((TARGET_HARD_FLOAT && flag_unsafe_math_optimizations && TARGET_RECIP_DIV) && (TARGET_DOUBLE_FLOAT))
...
#define HAVE_rsqrtesf ((TARGET_HARD_FLOAT && flag_unsafe_math_optimizations && TARGET_RECIP_SQRT) && (TARGET_HARD_FLOAT))
#define HAVE_rsqrtedf ((TARGET_HARD_FLOAT && flag_unsafe_math_optimizations && TARGET_RECIP_SQRT) && (TARGET_DOUBLE_FLOAT))
...
#define HAVE_lsx_vfrecipe_d (ISA_HAS_LSX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_DIV)
#define HAVE_lsx_vfrecipe_s (ISA_HAS_LSX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_DIV)
...
#define HAVE_lsx_vfrsqrte_d (ISA_HAS_LSX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_SQRT)
#define HAVE_lsx_vfrsqrte_s (ISA_HAS_LSX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_SQRT)
...
#define HAVE_roundv2df2 (ISA_HAS_LSX)
#define HAVE_roundv4sf2 (ISA_HAS_LSX)
...
#define HAVE_lasx_xvfrecipe_d (ISA_HAS_LASX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_DIV)
#define HAVE_lasx_xvfrecipe_s (ISA_HAS_LASX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_DIV)
...
#define HAVE_lasx_xvfrsqrte_d (ISA_HAS_LASX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_RSQRT)
#define HAVE_lasx_xvfrsqrte_s (ISA_HAS_LASX && flag_unsafe_math_optimizations && TARGET_RECIP_VEC_RSQRT)
...
#define HAVE_roundv4df2 (ISA_HAS_LASX)
#define HAVE_roundv8sf2 (ISA_HAS_LASX)
